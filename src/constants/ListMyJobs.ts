export const myJobs = [
  {
    ...
    discutir sobre a experiência do usuário junto ao time de design,
    conduzir e auxiliar a atuação de novos desenvolvedores na equipe.
    Atuando proativamente dando novas ideias de melhorias para o P.O. e
    fazendo auto-gerenciamento de tempo.`,
  },
  {
    name: "Conarh + Unitok",
    stacks: ["Next", "Node", "Typescript", "Aws", "Css-In-Js", "MongoDB"],
    ...
    description: ` Responsável pela plataforma de controle de mailing dos expositores
     ...
     funções: participar da concepção da solução, discutindo fluxos e
      garantindo uma boa experiência do usuário junto ao time de design, 
      apresentar e desenvolver as funcionalidades da plataforma, dar 
      assistência e correções ágeis em tempo real, conduzir e organizar a 
